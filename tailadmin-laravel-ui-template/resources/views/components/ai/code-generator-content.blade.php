...
@props([
    'userMessage' => 'Give me a login form code with google & github authentication',
...
HTML,
    'description' => 'Here is the code for login form with google and github authentication as described.',
])

@php
    $codeBlockId = 'code-block-' . Str::random(8);
@endphp
<div class="no-scrollbar relative z-20 max-h-[50vh] space-y-7 overflow-y-auto pb-7">
    ...
    <!-- AI Response -->
    <div class="flex lg:justify-start" x-data="{ copied: false }">
        <div class="w-full flex-1">
            <div class="dark:bg-dark-primary shadow-theme-xs relative w-full rounded-[20px] border border-gray-200 bg-white lg:max-w-3xl dark:border-gray-800 dark:bg-white/[0.03]">
                <div class="flex items-center justify-between border-b border-gray-200 px-5 py-4 dark:border-gray-800">
                    <div class="flex items-center gap-1.5 text-gray-500 dark:text-gray-400">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                            <path d="M5.0625 5.99976L2.0625 9.00003L5.0625 12M12.9375 5.99976L15.9375 9.00003L12.9375 12M10.3329 2.99994L7.66626 14.9999" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                ...
                <div class="custom-scrollbar max-h-[350px] w-full overflow-y-auto px-5 py-4">
                    <pre><code id="{{ $codeBlockId }}" class="language-{{ $language }}">{{ $code }}</code></pre>
                </div>
            </div>
            <div class="mt-4">
