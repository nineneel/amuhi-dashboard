 <div class="custom-scrollbar relative z-20 mx-auto max-h-[50vh] max-w-[720px] flex-1 space-y-7 overflow-y-auto">
     <!-- User Message -->
     ...
     <div class="mb-6 flex justify-start">
         <div class="max-w-[720px]">
             <div class="relative rounded-xl">
                 <img src="/images/ai/video-thumb.png" class="w-full rounded-xl" alt="" />
                 <a href="https://www.youtube.com/watch?v=_iHmNaQBtKk"
