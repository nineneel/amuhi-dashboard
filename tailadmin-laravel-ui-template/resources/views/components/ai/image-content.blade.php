 <div class="custom-scrollbar relative z-20 max-h-[50vh] space-y-7 overflow-y-auto pb-7">
     <!-- User Message -->
     ...
     <div class="mb-6 flex justify-start">
         <div class="max-w-3xl">
             <div class="relative rounded-xl">
                 <img src="/images/ai/img-lg.png" class="w-full rounded-xl" alt="" />
             </div>
             <div class="mt-3">
                 <button
                 ...
                 <p class="mt-3 text-sm leading-5 text-gray-500 dark:text-gray-400">
                     ...
                     features modern elements with reflective glass panels that shimmer beautifully under the
                     sunlight.
                 </p>
             </div>
         </div>
     ...
     <div class="mb-6 flex justify-start">
         <div class="max-w-3xl">
             <div class="grid grid-cols-2 gap-3.5">
                 <div class="relative">
                     <img src="/images/ai/img-md-1.png" class="w-full rounded-xl" alt="" />
                     <button
                         class="mt-3 flex h-8 items-center gap-1 rounded-full border border-gray-100 bg-white px-3 py-1.5 text-xs font-medium text-gray-500 hover:text-gray-700 dark:border-gray-800 dark:bg-gray-900 dark:text-gray-400 dark:hover:text-gray-300">
                         <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"
                             fill="none">
                             <path
                                 d="M16.6671 13.3333V15.4166C16.6671 16.107 16.1074 16.6666 15.4171 16.6666H4.58301C3.89265 16.6666 3.33301 16.107 3.33301 15.4166V13.3333M10.0013 13.3333L10.0013 3.33331M6.14553 9.47948L9.99958 13.3311L13.8539 9.47948"
                 ...
                 <div class="relative">
                     <img src="/images/ai/img-md-2.png" class="w-full rounded-xl" alt="" />
                     <button
                         class="mt-3 flex h-8 items-center gap-1 rounded-full border border-gray-100 bg-white px-3 py-1.5 text-xs font-medium text-gray-500 hover:text-gray-700 dark:border-gray-800 dark:bg-gray-900 dark:text-gray-400 dark:hover:text-gray-300">
                         <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"
                             fill="none">
             ...
             <div class="mt-3">
                 <p class="mt-3 text-sm leading-5 text-gray-500 dark:text-gray-400">
                     Here are two tall buildings with sleek glass facades, just as described. Both structures
                     showcase modern design elements, glass panels that shimmer beautifully in the sunlight.
                 </p>
             </div>
         </div>
     </div>
