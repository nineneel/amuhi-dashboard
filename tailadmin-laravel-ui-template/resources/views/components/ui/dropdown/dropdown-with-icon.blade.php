...
@php
    ...
    // Icons are stored as raw SVG strings and will be rendered with {!! !!}.
    $menuItems = $menuItems ?? [
        [
            'text' => 'Edit Profile',
            'icon' => <<<'SVG'
<svg class="w-6 h-6 flex-none" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
