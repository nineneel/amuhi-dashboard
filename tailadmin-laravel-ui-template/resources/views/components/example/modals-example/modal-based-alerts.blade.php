<x-common.component-card title="Modal Based Alerts">
    ...
    {{-- Success Modal --}}
    <x-ui.modal x-data="{ open: false }" @open-success-modal.window="open = true" :isOpen="false" class="max-w-[600px]">
    ...
    {{-- Info Modal --}}
    <x-ui.modal x-data="{ open: false }" @open-info-modal.window="open = true" :isOpen="false" class="max-w-[600px]">
        <div class="relative w-full rounded-3xl bg-white p-6 dark:bg-gray-900 lg:p-10">
            <div class="text-center">
                <div class="relative flex items-center justify-center z-1 mb-7">
    ...
    {{-- Warning Modal --}}
    <x-ui.modal x-data="{ open: false }" @open-warning-modal.window="open = true" :isOpen="false" class="max-w-[600px]">
    ...
    {{-- Danger Modal --}}
    <x-ui.modal x-data="{ open: false }" @open-danger-modal.window="open = true" :isOpen="false" class="max-w-[600px]">
        <div class="relative w-full rounded-3xl bg-white p-6 dark:bg-gray-900 lg:p-10">
            <div class="text-center">
                <div class="relative flex items-center justify-center z-1 mb-7">
