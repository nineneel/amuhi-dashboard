@props(['orders' => [], 'title' => 'Recent Orders'])
...
@php
    $defaultOrders = [
        [
            'product' => 'TailGrids',
            'category' => 'UI Kit',
            'country_flag' => asset('images/country/country-01.svg'),
            'country' => 'USA',
            'cr' => 'Dashboard',
            'value' => '$12,499',
        ],
        [
            'product' => 'GrayGrids',
            'category' => 'Templates',
            'country_flag' => asset('images/country/country-03.svg'),
            'country' => 'UK',
            'cr' => 'Dashboard',
            'value' => '$5,498',
        ],
        [
            'product' => 'Uideck',
            'category' => 'Templates',
            'country_flag' => asset('images/country/country-04.svg'),
            'country' => 'Canada',
            'cr' => 'Dashboard',
            'value' => '$4,521',
        ],
        [
            'product' => 'FormBold',
            'category' => 'SaaS',
            'country_flag' => asset('images/country/country-05.svg'),
            'country' => 'Australia',
            'cr' => 'Dashboard',
            'value' => '$13,843',
        ],
        [
            'product' => 'NextAdmin',
            'category' => 'Dashboard',
            'country_flag' => asset('images/country/country-06.svg'),
            'country' => 'Germany',
            'cr' => 'Dashboard',
            'value' => '$7,523',
        ],
        [
            ...
            'category' => 'SaaS',
            'country_flag' => asset('images/country/country-07.svg'),
            'country' => 'France',
            'cr' => 'Dashboard',
            'value' => '$1,377',
        ],
        [
            'product' => 'AyroUI',
            'category' => 'UI Kit',
            'country_flag' => asset('images/country/country-08.svg'),
            'country' => 'Japan',
            'cr' => 'Dashboard',
            'value' => '$599.00',
        ],
...
<div class="overflow-hidden rounded-2xl border border-gray-200 bg-white pt-4 dark:border-gray-800 dark:bg-white/[0.03]">
    <div class="flex flex-col gap-4 px-6 mb-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div class="flex items-center gap-3">
            <button type="button" class="inline-flex items-center gap-2 rounded-lg border border-gray-300 bg-white px-4 py-3 text-theme-sm font-medium text-gray-700 shadow-theme-xs hover:bg-gray-50 hover:text-gray-800 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-white/[0.03] dark:hover:text-gray-200">
                        ...
                        <td class="px-6 py-3.5">
                            <div class="flex items-center">
                                <div class="w-5 h-5 overflow-hidden rounded-full">
                                    <img src="{{ $order['country_flag'] }}" alt="{{ $order['country'] }}" />
                                </div>
                            </div>
                        </td>
                        <td class="px-6 py-3.5">
