@props(['campaigns' => [], 'title' => 'Featured Campaigns'])

@php
    $defaultCampaigns = [
        [
            'creator' => ['name' => 'Wilson Gouse', 'image_url' => asset('images/user/user-01.jpg')],
        ...
        [
            'creator' => ['name' => 'Terry Franci', 'image_url' => asset('images/user/user-02.jpg')],
        ...
        [
            'creator' => ['name' => 'Alena Franci', 'image_url' => asset('images/user/user-03.jpg')],
        ...
        [
            'creator' => ['name' => 'Jocelyn Kenter', 'image_url' => asset('images/user/user-04.jpg')],
        ...
        [
            'creator' => ['name' => 'Brandon Philips', 'image_url' => asset('images/user/user-05.jpg')],
            'brand' => ['name' => 'Brand 2', 'logo' => asset('images/brand/brand-02.svg')],
            'title' => 'Self branding',
            'type' => 'Ads campaign',
            'status' => 'Success',
        ...
        [
            'creator' => ['name' => 'James Lipshutz', 'image_url' => asset('images/user/user-06.jpg')],
            'brand' => ['name' => 'Brand 3', 'logo' => asset('images/brand/brand-03.svg')],
            'title' => 'Increase your website tra...',
            'type' => 'Ads campaign',
            'status' => 'Success',
    ...
    $campaignsList = !empty($campaigns) ? $campaigns : $defaultCampaigns;
    ...
    <div class="max-w-full overflow-x-auto">
        <table class="min-w-full">
            ...
            <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                @forelse($campaignsList as $campaign)
                    <tr>
                        <td class="py-3">
                            <div class="flex items-center gap-[18px]">
                                <div class="w-10 h-10 overflow-hidden rounded-full">
                                    <img src="{{ $campaign['creator']['image_url'] }}"
                                        alt="{{ $campaign['creator']['name'] }}" class="w-full h-full object-cover" />
                                </div>
                                <div>
