<div class="rounded-xl bg-white p-4 dark:bg-gray-900">
    <div class="flex items-end justify-between">
        <div>
            <p class="text-sm text-gray-500 dark:text-gray-400">Tracking ID</p>
            <h3 class="text-lg font-semibold text-gray-800 dark:text-white/90">#28745-72809bjk</h3>
        </div>
        <div class="relative">
            <span class="bg-success-50 text-success-600 dark:bg-success-500/15 dark:text-success-500 inline-flex items-center justify-center gap-1 rounded-full px-2.5 py-0.5 text-sm font-medium">In Transit</span>
        </div>
    </div>
    <div class="mt-5">
        <!-- Timeline item -->
        <div class="relative pb-5 pl-11">
            ...
            <div class="ml-2 flex items-end justify-between">
                <div>
                    <p class="text-sm text-gray-500 dark:text-gray-400">12 Apr 2028</p>
                    <h4 class="font-medium text-gray-800 dark:text-white/90">Picked up</h4>
                </div>
            ...
            <!-- Vertical line -->
            <div class="border-brand-500 absolute top-10 left-5 h-full w-px border border-dashed"></div>
        </div>
        ...
        <div class="relative pb-5 pl-11">
            ...
            <div class="ml-2 flex justify-between">
                <div>
                    <p class="text-sm text-gray-500 dark:text-gray-400">12 Apr 2028</p>
                    <h4 class="font-medium text-gray-800 dark:text-white/90">In Transit</h4>
                </div>
        ...
        <div class="relative pl-11">
            ...
            <div class="ml-2 flex justify-between">
                <div>
                    <p class="text-sm text-gray-500 dark:text-gray-400">13 Apr 2028</p>
                    <h4 class="font-medium text-gray-800 dark:text-white/90">Delivered</h4>
                </div>
