@props(['stocks' => [], 'title' => 'Trending Stocks'])
...
@php
    ...
    $stocksList = !empty($stocks) ? $stocks : $defaultStocks;
@endphp
...
<div class="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] sm:p-6">
    ...
    <div class="swiper stocksSlider">
     <swiper-container
        ...
        breakpoints='{"768": {"slidesPerView": 2}, "1280": {"slidesPerView": 2.3}, "1536": {"slidesPerView": 2.3}}'
    >
        @foreach($stocksList as $stock)
            <swiper-slide>
                <div class="rounded-2xl bg-gray-100 p-5 dark:bg-white/[0.03]">
                    ...
                    <div class="flex items-center gap-3">
                        <button class="flex w-full items-center justify-center rounded-lg border border-gray-300 bg-white p-3 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-white/[0.03]">
                            Short Stock
                        </button>

                        <button class="flex items-center justify-center w-full p-3 font-medium text-white rounded-lg bg-blue-500 text-sm shadow-sm hover:bg-blue-600">
                            Buy Stock
                        </button>
                    </div>
                </div>
