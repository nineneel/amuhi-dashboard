...
export function initChartSeventeen() {
    const chartEl = document.querySelector('#chartSeventeen');
    if (chartEl) {
        ...
        const chartSeventeen = new ApexCharts(chartEl, chartSeventeenOptions);
        chartSeventeen.render();
        return chartSeventeen;
    }
}

export default initChartSeventeen;
