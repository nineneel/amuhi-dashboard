...
export function initChartNineteen() {
    const chartEl = document.querySelector('#chartNineteen');
    if (chartEl) {
        ...
        const chartNineteen = new ApexCharts(chartEl, chartNineteenOptions);
        chartNineteen.render();
        return chartNineteen;
    }
}

export default initChartNineteen;
