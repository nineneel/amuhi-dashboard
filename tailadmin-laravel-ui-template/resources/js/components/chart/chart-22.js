...
export function initChartTwentyTwo() {
    const chartEl = document.querySelector('#chartTwentyTwo');
    if (chartEl) {
        ...
        const chartTwentyTwo = new ApexCharts(chartEl, chartOptions);
        chartTwentyTwo.render();
        return chartTwentyTwo;
    }
}
export default initChartTwentyTwo;
