<x-common.component-card title="Form in Modal">
    <x-ui.button size="sm" variant="primary" @click="$dispatch('open-form-in-modal')">Open Modal</x-ui.button>

    <x-ui.modal x-data="{ open: false }" @open-form-in-modal.window="open = true" :isOpen="false" class="max-w-[584px]">
