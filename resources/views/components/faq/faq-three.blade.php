    ...
    $faqColumns = [
        [
            [
                ...
                'answer' => 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent et nunc ut risus imperdiet lacinia.<br><br>Lorem ipsum dolor sit amet, consectetur adipiscing elit.'
            ],
            [
...
<div class="gird-cols-1 grid gap-x-8 xl:grid-cols-2">
    @foreach($faqColumns as $columnIndex => $column)
