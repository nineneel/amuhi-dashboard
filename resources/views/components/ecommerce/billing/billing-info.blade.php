                                ...
                                <form @submit.prevent="handleSave">
                                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                        ...
                                        <div class="sm:col-span-1">
                                            <x-form.select label="Country" name="country" x-model="formData.country">
                                                <option value="" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">
                                                    Select Option
                                                </option>
                                                <option value="USA" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">
                                                    USA
                                                </option>
                                                <option value="UK" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">
                                                    UK
                                                </option>
                                                <option value="BD" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">
                                                    BD
                                                </option>
                                                <option value="EU" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">
                                                    EU
                                                </option>
                                                <option value="ID" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">
                                                    ID
                                                </option>
                                            </x-form.select>
                                        </div>
                                        <div class="sm:col-span-1">
                                            <x-form.select label="Town/City" name="city" x-model="formData.city">
                                                <option value="" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">
                                                    Select Option
                                                </option>
                                                <option value="New York" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">
                                                    New York
                                                </option>
                                                <option value="Tokyo" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">
                                                    Tokyo
                                                </option>
                                                <option value="Chicago" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">
                                                    Chicago
                                                </option>
                                                <option value="Los Angels" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">
                                                    Los Angels
                                                </option>
                                                <option value="Berlin" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">
                                                    Berlin
                                                </option>
                                            </x-form.select>
                                        </div>
