    ...
    <div class="flex items-center justify-between border-b border-gray-200 px-5 py-4 dark:border-gray-800">
        ...
        <div class="flex gap-3.5">
            <div class="hidden h-11 items-center gap-0.5 rounded-lg bg-gray-100 p-0.5 lg:inline-flex dark:bg-gray-900">
                ...
                <button @click="filterStatus = 'Unpaid'; currentPage = 1"
                    :class="filterStatus === 'Unpaid' ?
                        'shadow-theme-xs text-gray-900 dark:text-white bg-white dark:bg-gray-800' :
                        'text-gray-500 dark:text-gray-400'"
                    class="text-theme-sm h-10 rounded-md px-3 py-2 font-medium hover:text-gray-900 dark:hover:text-white">
                    Unpaid
        ...
        <table class="w-full table-auto">
            <thead>
                <tr class="border-b border-gray-200 dark:divide-gray-800 dark:border-gray-800">
                        ...
                        <div class="flex w-full cursor-pointer items-center justify-between">
                            <div class="flex items-center gap-3">
                                <label
                                    ...
                                    <span class="relative">
                                        <input type="checkbox" class="sr-only" @change="toggleSelectAll"
                    ...
                    <th class="cursor-pointer p-4 text-left text-xs font-medium text-gray-700 dark:text-gray-400"
                        @click="sort('customer')">
                        <div class="flex items-center gap-3">
                            <p class="text-theme-xs font-medium text-gray-700 dark:text-gray-400">
                                Customer
                            ...
                            <span class="flex flex-col gap-0.5">
                                <svg :class="sortBy === 'customer' && sortDirection === 'asc' ? 'text-brand-500' :
                                    'text-gray-300'"
                                ...
                                <svg :class="sortBy === 'customer' && sortDirection === 'desc' ? 'text-brand-500' :
                                    'text-gray-300'"
                                    width="8" height="5" viewBox="0 0 8 5" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                    ...
                    <th class="cursor-pointer p-4 text-left text-xs font-medium text-gray-700 dark:text-gray-400"
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <span class="flex flex-col gap-0.5">
                                <svg :class="sortBy === 'creationDate' && sortDirection === 'asc' ? 'text-brand-500' :
                                    'text-gray-300'"
                                    width="8" height="5" viewBox="0 0 8 5" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                                ...
                                <svg :class="sortBy === 'creationDate' && sortDirection === 'desc' ? 'text-brand-500' :
                                    'text-gray-300'"
                                    width="8" height="5" viewBox="0 0 8 5" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                    ...
                    <th class="cursor-pointer p-4 text-left text-xs font-medium text-gray-700 dark:text-gray-400"
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <span class="flex flex-col gap-0.5">
                                <svg :class="sortBy === 'dueDate' && sortDirection === 'asc' ? 'text-brand-500' :
                                    'text-gray-300'"
                                    width="8" height="5" viewBox="0 0 8 5" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                                ...
                                <svg :class="sortBy === 'dueDate' && sortDirection === 'desc' ? 'text-brand-500' :
                                    'text-gray-300'"
                                    width="8" height="5" viewBox="0 0 8 5" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                            ...
                            <div class="group flex items-center gap-3">
                                <label
                                    ...
                                    <span class="relative">
                                        ...
                                        <span
                                            :class="selected.includes(invoice.id) ? 'border-brand-500 bg-brand-500' :
                                                'bg-transparent border-gray-300 dark:border-gray-700'"
                                            class="flex h-4 w-4 items-center justify-center rounded-sm border-[1.25px]">
                                ...
                                <p class="text-theme-xs font-medium text-gray-700 group-hover:underline dark:text-gray-400" x-text="invoice.number"></p>
                            </div>
                        </td>
                        <td class="p-4 whitespace-nowrap">
                            <span class="text-sm font-medium text-gray-700 dark:text-gray-400" x-text="invoice.customer"></span>
                        </td>
                        <td class="p-4 whitespace-nowrap">
                            <p class="text-sm text-gray-700 dark:text-gray-400" x-text="invoice.creationDate"></p>
                        </td>
                        <td class="p-4 whitespace-nowrap">
                            <p class="text-sm text-gray-700 dark:text-gray-400" x-text="invoice.dueDate"></p>
                        </td>
                        <td class="p-4 whitespace-nowrap">
                            <p class="text-sm text-gray-700 dark:text-gray-400" x-text="invoice.total"></p>
                        </td>
                        <td class="p-4 whitespace-nowrap">
                            <span
        ...
        <div class="pb-3 sm:pb-0">
            <span class="block text-sm font-medium text-gray-500 dark:text-gray-400">
                ...
                <span class="text-gray-800 dark:text-white/90"
                    x-text="((currentPage - 1) * itemsPerPage) + (paginatedInvoices.length ? 1 : 0)"></span>
                to
                <span class="text-gray-800 dark:text-white/90"
                    x-text="((currentPage - 1) * itemsPerPage) + paginatedInvoices.length"></span>
                of
                <span class="text-gray-800 dark:text-white/90" x-text="invoices.length"></span>
            </span>
        </div>
        <div
