@php
    $plans = [
        [
            ...
            'button_class' => 'bg-gray-800 hover:bg-brand-500 dark:bg-white/10',
            'border_class' => 'border-gray-200 dark:border-gray-800',
            'divider_class' => 'bg-gray-200 dark:bg-gray-800',
            'icon' => 'personal',
            'features' => [
        ...
        [
            ...
            'button_class' => 'bg-brand-500 hover:bg-brand-600',
            'border_class' => 'border-2 border-brand-500',
            'divider_class' => 'bg-white/20',
            'icon' => 'professional',
            'featured' => true,
            'features' => [
...
<div class="grid gap-5 grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 xl:gap-6">
    @foreach ($plans as $plan)
        <div class="rounded-2xl border {{ $plan['border_class'] }} bg-white p-6 dark:bg-white/[0.03] xl:p-8">
            ...
            <div class="flex items-end mt-4">
                ...
                <span class="inline-block mb-1 ml-1 text-sm text-gray-500 dark:text-gray-400">/ Lifetime</span>
            </div>
            ...
            <div class="w-full h-px my-6 {{ $plan['divider_class'] }}"></div>

            <ul class="mb-8 space-y-3">
                @foreach ($plan['features'] as $feature)
                    <li
                        class="flex items-center gap-3 text-sm {{ $feature['included'] ? 'text-gray-700 dark:text-gray-400' : 'text-gray-400' }}">
                        @if ($feature['included'])
            ...
            <button
                class="flex w-full items-center justify-center rounded-lg {{ $plan['button_class'] }} p-3.5 text-sm font-medium text-white shadow-theme-xs transition-colors">
                {{ $plan['button_text'] }}
            </button>
        </div>
    @endforeach
