        ...
        <div
            ...
            <button
	            ...
	            <a href="{{ route('dashboard') }}" class="xl:hidden">
	                ...
	                <img class="hidden h-8 w-auto max-w-[160px] object-contain dark:block dark:brightness-0 dark:invert" src="/images/logo/logo-dark.png" alt="Logo" />
	            </a>
	            ...
	            <div class="hidden">
	                <form>
	                    <div class="relative">
	                        ...
	                        <input type="text" placeholder="{{ __('ui.header.search_placeholder') }}"
