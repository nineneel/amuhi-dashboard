...
@section('content')
    ...
    <div class="rounded-2xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-white/[0.03]">
        <div class="mb-4 flex flex-wrap items-center justify-between gap-3">
            <div>
                <h3 class="text-base font-semibold text-gray-800 dark:text-white/90">All Notifications</h3>
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">{{ $notifications->count() }} total, {{ $unreadCount }} unread</p>
            </div>
        ...
        @if ($notifications->isEmpty())
            <p class="text-sm text-gray-500 dark:text-gray-400">You have no notifications.</p>
        @else
            <div class="space-y-3">
