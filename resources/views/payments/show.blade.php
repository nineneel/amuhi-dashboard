	            ...
	            <div class="space-y-6 lg:col-span-8">
	                <div class="rounded-2xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-white/[0.03]">
	                    <div class="flex items-start justify-between gap-4">
	                        <div>
	                            <h3 class="text-lg font-semibold text-gray-900 dark:text-white">{{ __('ui.payments.membership_package') }}</h3>
	                            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
	                                {{ $shouldChargeRegistrationFee ? __('ui.payments.one_time_plus_annual') : __('ui.payments.annual_renewal') }}
	                            </p>
	                        </div>
	                        <div class="text-right">
	                            <p class="text-xs text-gray-500 dark:text-gray-400">{{ __('ui.payments.total') }}</p>
                            ...
                            <div class="shrink-0 text-right">
                                ...
                                @if (($annualPlan?->duration_days ?? 0) > 0)
                                    <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                                        {{ __('ui.payments.days', ['count' => (int) $annualPlan->duration_days]) }}
                                    </p>
                                @endif
                            </div>
                        </div>
	                ...
	                @if ($isActiveSubscription)
	                    <div class="rounded-2xl border border-gray-200 bg-gray-50 p-5 dark:border-gray-800 dark:bg-white/[0.03]">
	                        <p class="text-sm font-medium text-gray-900 dark:text-white">{{ __('ui.payments.subscription_active') }}</p>
	                        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
