...
@section('content')
    @php
	    ...
	    @if (! $hasActiveSubscription)
	        <x-ui.alert variant="warning" :title="__('ui.dashboard.subscription_required')"
	            :message="__('ui.dashboard.subscription_required_message')"
	            class="mb-6" />
	    @endif
    ...
    <div class="grid gap-6 xl:grid-cols-12">
        <div class="space-y-6 xl:col-span-8">
            <div class="rounded-2xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-white/[0.03]">
	                <div class="flex flex-wrap items-start justify-between gap-4">
	                    ...
	                    <div class="grid gap-3 sm:grid-cols-3">
	                        <div class="rounded-xl border border-gray-200 px-4 py-3 text-center dark:border-gray-800">
	                            <p class="text-xs text-gray-500 dark:text-gray-400">{{ __('ui.dashboard.unread_notifications') }}</p>
	                        ...
	                        <div class="rounded-xl border border-gray-200 px-4 py-3 text-center dark:border-gray-800">
	                            <p class="text-xs text-gray-500 dark:text-gray-400">{{ __('ui.dashboard.pending_invoices') }}</p>
	            ...
	            <div class="rounded-2xl border border-gray-200 bg-white px-6 py-4 dark:border-gray-800 dark:bg-white/[0.03]">
	                <div class="mb-3 flex items-center justify-between">
	                    <h3 class="text-base font-semibold text-gray-800 dark:text-white/90">{{ __('ui.dashboard.upcoming_events') }}</h3>
	                    <a href="{{ route('events.index') }}" class="text-sm text-brand-500 hover:text-brand-600 dark:text-brand-400">{{ __('ui.common.view_all') }}</a>
	                </div>
	                ...
	                @else
	                    <div class="space-y-2.5">
                            ...
                            @php
	                                ...
	                                $eventStatusLabel = trans()->has($eventStatusKey) ? __($eventStatusKey) : ucfirst($status);
	        ...
	        <div class="space-y-6 xl:col-span-4">
	            <div class="rounded-2xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-white/[0.03]">
	                <h3 class="mb-2 text-base font-semibold text-gray-800 dark:text-white/90">{{ __('ui.dashboard.recent_activity') }}</h3>
	            ...
	            <div class="rounded-2xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-white/[0.03]">
	                <h3 class="mb-4 text-base font-semibold text-gray-800 dark:text-white/90">{{ __('ui.dashboard.quick_actions') }}</h3>
