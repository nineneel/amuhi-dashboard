<header class="sticky top-0 z-99999 flex w-full border-b border-gray-200 bg-white dark:border-gray-800 dark:bg-gray-900">
    <div class="flex w-full items-center justify-between gap-3 px-3 py-2.5 sm:gap-4 xl:px-6 lg:py-3">
            <div class="flex items-center gap-2 sm:gap-4">
                ...
                <a href="{{ route('admin.dashboard') }}" class="xl:hidden">
                    <img class="h-8 w-auto max-w-[160px] object-contain dark:hidden" src="/images/logo/logo.png" alt="Logo" />
                    <img class="hidden h-8 w-auto max-w-[160px] object-contain dark:block dark:brightness-0 dark:invert"
            ...
            @include('admin.components.user-dropdown')
    </div>
</header>
