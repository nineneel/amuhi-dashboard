<div class="flex justify-between rounded-xl bg-white p-2 dark:bg-gray-900">
    <div class="flex items-center gap-3">
        <div>
            <img src="/images/logistics/avatar-1.png" class="h-12 w-12 rounded-full" alt="" />
        </div>
        <div>
            <p class="text-xs text-gray-500 dark:text-gray-400">Courier</p>
            <h3 class="text-sm font-medium text-gray-800 dark:text-white/90">Devid walthen</h3>
        </div>
    </div>
    <div class="flex items-center gap-2">
        <div
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                ...
                <path d="M4.35449 8.08057H4.36283M8.00033 8.08057H8.00866M11.6462 8.08057H11.6545" stroke="#344054"
