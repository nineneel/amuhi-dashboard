    ...
    <div class="flex items-center justify-between border-b border-gray-200 px-5 py-4 dark:border-gray-800">
        ...
        <div class="flex gap-3.5">
            ...
            <div x-data="{
                ...
                @foreach ($tabs as $tab)
                    <button
                    @click="changeTab('{{ $tab['key'] }}'); $dispatch('change-tab', '{{ $tab['key'] }}')"
                        ...
                        <tr class="transition hover:bg-gray-50 dark:hover:bg-gray-900">
                                ...
                                <div class="flex items-center gap-3">
                                    <label
                                        ...
                                        <span class="relative">
                                            ...
                                            <span
                                                :class="selected.includes(ticket.id) ? 'border-brand-500 bg-brand-500' :
                                                    'bg-transparent border-gray-300 dark:border-gray-700'"
                                                class="flex h-4 w-4 items-center justify-center rounded-sm border-[1.25px]">
                            ...
                            <td class="px-4 py-3 whitespace-nowrap">
                                <div>
                                    ...
                                    <p class="text-sm text-gray-500 dark:text-gray-400" x-text="ticket.email"></p>
                                </div>
                            </td>
                            <td class="px-4 py-3 whitespace-nowrap">
        ...
        <div
            ...
            <div class="pb-3 sm:pb-0">
                <span class="block text-sm font-medium text-gray-500 dark:text-gray-400">
                    Showing
                    <span class="text-gray-800 dark:text-white/90" x-text="((currentPage-1)*perPage+1)"></span>
                    to
                    <span class="text-gray-800 dark:text-white/90"
                        x-text="Math.min(currentPage*perPage, tickets.length)"></span>
                    of
                    <span class="text-gray-800 dark:text-white/90" x-text="tickets.length"></span>
                </span>
            </div>
            <div
