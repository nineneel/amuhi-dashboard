            ...
            <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                <div>
                    <label for="invoice-number"
                        class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">Invoice Number</label>
                ...
                <div>
                    <label for="customer-name"
                        class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">Customer Name</label>
                ...
                <div>
                    <x-form.date-picker id="issue_date" name="issue_date" label="Issue Date"
                        placeholder="Select issue date" defaultDate="{{ now()->format('Y-m-d') }}" />
                </div>
                <div>
                    <x-form.date-picker id="due-date" label="Due Date" placeholder="Select due date" name="due-date" />
                </div>
                <div class="col-span-full">
                    <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                        Additional Info
                    </label>
                    <textarea placeholder="Receipt Info (optional)" type="text" rows="7"
    ...
    <div class="border-b border-gray-200 p-4 sm:p-8 dark:border-gray-800" x-data="invoiceProducts()">
        ...
        <div
            ...
            <form @submit.prevent="addProduct">
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-3 lg:grid-cols-12">
                    <div class="w-full lg:col-span-3">
                        <label class="mb-1 inline-block text-sm font-semibold text-gray-700 dark:text-gray-400">Product
                            Name</label>
            ...
            <div class="mt-5 flex max-w-2xl items-center gap-2">
                <svg class="text-gray-500 dark:text-gray-400" width="20" height="20" viewBox="0 0 20 20"
            ...
            <div class="mt-6 w-full space-y-1 text-right sm:w-[220px]">
                ...
                <ul class="space-y-2">
                    <li class="flex justify-between gap-5">
                        ...
                        <span class="text-sm font-medium text-gray-700 dark:text-gray-400" x-text="'$' + subtotal" />
                    </li>
                    <li class="flex items-center justify-between">
                        <span class="text-sm text-gray-500 dark:text-gray-400">Vat (10%):</span>
                        <span class="text-sm font-medium text-gray-700 dark:text-gray-400" x-text="'$' + vat" />
                    </li>
                    <li class="flex items-center justify-between">
                        <span class="font-medium text-gray-700 dark:text-gray-400">Total</span>
                        <span class="text-lg font-semibold text-gray-800 dark:text-white/90" x-text="'$' + total" />
                    </li>
                </ul>
            </div>
        </div>
    </div>
    <div class="p-4 sm:p-8" x-data="{ previewModal: false }">
        ...
        <!-- Preview Modal -->
        <x-ui.modal x-data="{ open: false }" @open-preview-modal.window="open = true" :isOpen="false" class="max-w-[720px]">
            <div class="no-scrollbar flex flex-col overflow-y-auto px-4 py-4">
                <div class="relative w-full max-w-[720px] rounded-3xl bg-white dark:bg-gray-900">
                            ...
                            <div class="w-[220px]">
                                ...
                                <ul class="space-y-2">
                                    <li class="flex justify-between gap-5">
                                        ...
                                        <span
                                            class="text-sm font-medium text-gray-700 dark:text-gray-400">$3,850</span>
                                    </li>
                                    <li class="flex items-center justify-between">
                                        <span class="text-sm text-gray-500 dark:text-gray-400">
                                            Vat (10%):
                                    ...
                                    <li class="flex items-center justify-between">
                                        ...
                                        <span
                                            class="text-lg font-semibold text-gray-800 dark:text-white/90">$4,235</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
