<div class="w-full rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
    <div class="flex items-center justify-between border-b border-gray-200 px-6 py-4 dark:border-gray-800">
        ...
        <h4 class="text-base font-medium text-gray-700 dark:text-gray-400">ID : #348</h4>
    </div>
    ...
    <div class="p-5 xl:p-8">
        <div class="mb-9 flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
            <div>
                ...
                <h5 class="mb-2 text-base font-semibold text-gray-800 dark:text-white/90">Pimjo LLC</h5>
                ...
                <span class="block text-sm text-gray-500 dark:text-gray-400"> 11 March, 2027 </span>
            </div>
            ...
            <div class="sm:text-right">
                ...
                <h5 class="mb-2 text-base font-semibold text-gray-800 dark:text-white/90">Albert Ward</h5>
                ...
                <span class="block text-sm text-gray-500 dark:text-gray-400"> 16 March, 2027 </span>
            </div>
        </div>

        <!-- Invoice Table Start -->
        <x-ecommerce.invoice.invoice-details-table />
        <!-- Invoice Table End -->
