<div x-data="{
    ...
    <div
        ...
        <div class="flex items-center justify-between px-6 mb-4">
            ...
            <a href="/ecommerce" class="inline-flex items-center gap-2 text-gray-500 hover:text-blue-500 dark:text-gray-400 dark:hover:text-blue-500">
                View All
            </a>
        </div>
                ...
                <thead>
                    <tr class="border-t border-gray-200 dark:border-gray-800">
                        <template x-for="header in tableHeaders" :key="header">
                            <th class="px-6 py-3 font-medium text-left text-gray-500 text-theme-sm dark:text-gray-400"
                                x-text="header"></th>
                        </template>
                    ...
                    <template x-for="(row, index) in tableData" :key="index">
                        <tr class="border-t border-gray-100 dark:border-gray-800">
                            ...
                            <td class="px-6 py-[18px] text-gray-700 text-theme-sm dark:text-gray-400"
                                x-text="row.category"></td>
                            <td class="px-6 py-[18px] text-gray-700 text-theme-sm dark:text-gray-400" x-text="row.size">
                            </td>
                            <td class="px-6 py-[18px] text-gray-700 text-theme-sm dark:text-gray-400"
                                x-text="row.dateModified"></td>
                            <td class="px-6 py-[18px] text-center">
                                <div class="flex items-center justify-center gap-2">
                                    <button @click="deleteFile(index)"
                                        ...
                                        <svg class="fill-current" width="21" height="20" viewBox="0 0 21 20"
