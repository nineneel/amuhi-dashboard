@php
    $mediaItems = [
        [
            ...
            'files' => 245,
            'size' => '26.40 GB',
            'bg_class' => 'bg-success-500/[0.08]',
            'text_class' => 'text-success-500',
        ],
        [
            'title' => 'Videos',
            'icon' => 'video',
            ...
            'files' => 245,
            'size' => '26.40 GB',
            'bg_class' => 'bg-theme-pink-500/[0.08]',
            'text_class' => 'text-theme-pink-500',
        ],
        [
            'title' => 'Audio',
            'icon' => 'audio',
            ...
            'files' => 245,
            'size' => '26.40 GB',
            'bg_class' => 'bg-blue-light-500/[0.08]',
            'text_class' => 'text-blue-light-500',
        ],
        [
            'title' => 'Apps',
            'icon' => 'apps',
        ...
        [
            ...
            'files' => 245,
            'size' => '26.40 GB',
            'bg_class' => 'bg-warning-500/[0.08]',
            'text_class' => 'text-warning-500',
        ],
        [
            'title' => 'Downloads',
            'icon' => 'downloads',
            ...
            'files' => 245,
            'size' => '26.40 GB',
            'bg_class' => 'bg-theme-purple-500/[0.08]',
            'text_class' => 'text-theme-purple-500',
        ],
    ];
@endphp
            ...
            @foreach ($mediaItems as $item)
                <div
                    ...
                    <div class="flex items-center gap-4">
                        <div
                            class="flex h-[52px] w-[52px] items-center justify-center rounded-xl {{ $item['bg_class'] }} {{ $item['text_class'] }}">
                            @switch($item['icon'])
                                @case('image')
