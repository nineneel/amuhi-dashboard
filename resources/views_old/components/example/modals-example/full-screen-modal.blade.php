<x-common.component-card title="Full Screen Modal">
    <div x-data="{ isModalOpen: false }">
        <button
            class="bg-brand-500 shadow-theme-xs hover:bg-brand-600 rounded-lg px-4 py-3 text-sm font-medium text-white"
