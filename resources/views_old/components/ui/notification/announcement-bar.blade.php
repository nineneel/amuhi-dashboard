...
>
  <div class="flex items-start gap-3">
    ...
    <div class="flex flex-col items-center gap-5 sm:flex-row w-full">
      ...
      <div class="flex items-center w-full gap-3 sm:max-w-fit justify-center sm:justify-end">
        <button
          type="button"
          @if($onLater) wire:click="{{ $onLater }}" @endif
        ...
        <button
          type="button"
          @if($onUpdate) wire:click="{{ $onUpdate }}" @endif
